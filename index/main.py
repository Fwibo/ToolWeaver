...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str,
                        default="./data/ToolBench/toolgen-mean-embeddings-output-sentences-sbert-atomic_random.npy",
                        help="Input data path.")# "/data2/fangbowen/LC-Rec/data/Games/Games.emb-llama-td.npy""/data2/fangbowen/LC-Rec/data/ToolBench/toolgen-mean-embeddings.npy"
# /data2/fangbowen/LC-Rec/data/ToolBench/toolgen-mean-embeddings-output-sentences-sbert-atomic.npy
# default="/data2/fangbowen/LC-Rec/data/ToolBench/toolgen-mean-embeddings-output-sentences-sbert-atomic.npy",
    ...
    parser.add_argument("--graph_loss", type=bool, default=False, help="Similarity Regularization")
